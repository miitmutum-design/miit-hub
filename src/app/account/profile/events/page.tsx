    ...
    <div className="container mx-auto max-w-lg py-6 sm:py-8">
      ...
      <div className="space-y-4">
        <ActionCard 
            ...
            description="Cadastre um novo evento para seus clientes."
            href="/account/eventos/nova"
        />
        <ActionCard 
            icon={History}
            title="Histórico de Eventos"
            description="Visualize seus eventos ativos e passados."
            href="/account/eventos/historico"
        />
      </div>
